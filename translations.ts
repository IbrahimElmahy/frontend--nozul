...
const translationsData = {
  ar: {
    ...
    units: {
      manageUnits: 'إدارة الغرف السكنية',
      addUnit: 'إضافة غرفة',
      addGroupOfRooms: 'إضافة مجموعة غرف',
      searchUnits: 'ابحث عن غرفة...',
      showing: 'عرض',
      to: 'إلى',
      of: 'من',
      entries: 'إدخالات',
      deleteUnit: 'حذف الغرفة',
      confirmDelete: 'هل أنت متأكد أنك تريد حذف هذه الغرفة؟ لا يمكن التراجع عن هذا الإجراء.',
      ...
      checkInToday: 'وصول اليوم',
      notCheckedIn: 'لم يسجل وصول',
      outOfService: 'خارج الخدمة',
      cleaningStatus: 'حالة النظافة',
      type: 'النوع',
      searchPlaceholder: 'ابحث باسم العميل أو رقم الغرفة',
      export: 'تصدير',
      network: 'شبكة',
      table: 'جدول',
      debtor: 'مدين',
      ...
      suite: 'جناح',
      editUnit: 'تعديل الغرفة',
      unitInfo: 'معلومات الغرفة',
      unitName: 'اسم الغرفة',
      roomType: 'نوع الغرفة',
      cleaning: 'النظافة',
      available: 'متوفر',
      ...
      internet: 'انترنت',
      unitDetails: 'معلومات تفاصيل الغرفة',
      floor: 'الطابق',
      rooms: 'الغرف',
      ...
      addGroupOfRoomsTitle: 'إضافة مجموعة غرف',
      roomNumbering: 'ترقيم الغرف',
      fromRoomNumber: 'من رقم غرفة',
      toRoomNumber: 'إلى رقم غرفة',
  ...
  en: {
    ...
    units: {
      manageUnits: 'Residential Rooms Management',
      addUnit: 'Add Room',
      addGroupOfRooms: 'Add Group of Rooms',
      searchUnits: 'Search for a room...',
      showing: 'Showing',
      to: 'to',
      of: 'of',
      entries: 'entries',
      deleteUnit: 'Delete Room',
      ...
      checkInToday: 'Arriving Today',
      notCheckedIn: 'Not Checked In',
      outOfService: 'Out of service',
      cleaningStatus: 'Cleaning Status',
      type: 'Type',
      searchPlaceholder: 'Search by customer or room number',
      export: 'Export',
      network: 'Network',
      table: 'Table',
      debtor: 'Debtor',
