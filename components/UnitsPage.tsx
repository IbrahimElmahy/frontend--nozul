...
import { Unit, UnitStatus, CoolingType, Booking, Reservation, RentType, BookingStatus } from '../types';
...
const UnitsPage: React.FC = () => {
    ...
    const [bookingInitialData, setBookingInitialData] = useState<Booking | Omit<Booking, 'id' | 'bookingNumber' | 'createdAt' | 'updatedAt'>>(newBookingTemplate);
    ...
    const handleAddReservation = (unit: Unit) => {
        setBookingInitialData({
            ...newBookingTemplate,
            unitName: unit.id, // Pre-fill unit ID
            price: unit.price || 0,
            rent: unit.price || 0,
        });
    ...
    const tableHeaders: { key: keyof Unit | 'actions', labelKey: string }[] = [
        ...
        { key: 'unitTypeName' as keyof Unit, labelKey: 'units.th_type' },
    ...
    return (
        <div className="space-y-6">
            ...
            <AddBookingPanel
                ...
                isEditing={false}
                isOpen={isAddBookingPanelOpen}
                onClose={() => setIsAddBookingPanelOpen(false)}
