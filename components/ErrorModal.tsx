...
const ErrorModal: React.FC<ErrorModalProps> = (props) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 px-4 pb-20 text-center sm:block sm:p-0" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            ...
            {/* Background Overlay - Blocking (Transparent) */}
            ...
            <div className="relative z-10 inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border dark:border-slate-700">
