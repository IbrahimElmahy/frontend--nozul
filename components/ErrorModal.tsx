...
import ExclamationTriangleIcon from './icons-redesign/ExclamationTriangleIcon'; // Assuming you have this or similar
...
const ErrorModal: React.FC = () => {
    const { error, title, clearError } = useContext(ErrorContext);
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 px-4 pb-20 text-center sm:block sm:p-0" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            ...
            {/* Background Overlay */}
            <div className="fixed inset-0 transition-opacity" aria-hidden="true" onClick={clearError}>
