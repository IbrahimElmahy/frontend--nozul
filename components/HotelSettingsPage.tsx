...
const HotelSettingsPage: React.FC<HotelSettingsPageProps> = ({ setCurrentPage }) => {
    ...
    const settings = [
        ...
        { id: 'manageApartmentPrices', icon: CurrencySaudiRiyalIcon, page: 'dashboard' as Page },
        { id: 'managePeakTimes', icon: ClockIcon, page: 'dashboard' as Page },
        { id: 'manageTaxes', icon: CreditCardIcon, page: 'dashboard' as Page },
